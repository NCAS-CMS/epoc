...
2. Add your um job id to the **Suite** column on the [BSPNA simulations spreadsheet](https://docs.google.com/spreadsheets/d/1UNTNaphWJ1l3E8UryxRGrnxWaLYiY9NPnS1chptYPTA/edit?gid=738210318#gid=738210318). The **Docs** and **Monitor** columns will be autofilled
3. Make a page on the BSPNA github by clicking on the autofilled link in the **Docs** column
